...
function Translate() {
  return (
    <div className="content-stretch flex items-center justify-center px-[58px] relative shrink-0 w-[268px]" data-name="translate">
      <div className="flex flex-col font-['Segoe_UI:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] h-[36px] justify-center leading-[0] relative shrink-0 text-[#495260] text-[12px] text-center w-[266px]" style={{ fontVariationSettings: "'wght' 400" }}>
...
export default function MemoryCardNml() {
  return (
    <div className="opacity-80 relative rounded-[16px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.15)] size-full" data-name="memory-card-nml">
